...
Swagger UI for the [MySpawnerController](../README.md) game plugin API.
...
# Or run directly
dotnet run --project MySpawnerController.Swagger
```
...
DTOs live in `MySpawnerController.Shared/` (netstandard2.0) and are shared
...
1. Add/update DTO in `MySpawnerController.Shared/`
